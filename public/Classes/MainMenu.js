var MainMenu = function(_ctx, _color) {
    ...
    mm.buttons = [];
    mm.buttons.push(new Button(mm.ctx, "играть", w/4-30, h/2-80, mm.color, true, 10, 20, startGame ))
    mm.buttons.push(new Parameter(mm.ctx, "скорость", w/4-30, h/2-80 + 65, mm.color))
    mm.buttons.push(new Parameter(mm.ctx, "сложность карты", w/4-30, h/2-80 + 105, mm.color))
